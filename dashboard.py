...
# ==============================
# AI AGENT QUERY (Enter to Submit)
# ==============================
st.markdown("---")
st.markdown("## 💬 Ask the AI Agent")

with st.form("ai_query_form", clear_on_submit=True):
    prompt = st.text_input("Ask something about your data:", placeholder="e.g., What's the highest paid department?")
